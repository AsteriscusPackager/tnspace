window['__debug__'] = new Function('callback', 'if (!/^(http|https)\:/.test(location.protocol))callback(console.log)')
...
window['__ml_fw__'] = {
    __version: 'Base;Moonless/Framework/0.1',
    init: function() {
                        ...
                        function element(property = {}) {
                            ...
                            if (!!this.property['log']) {
                                if (typeof this.property['log'] === 'string') {
                                    ...
                                    try { console.log(this.property['log'].join(' ')) } catch {}
                                }
                            }
...
;((ml, fw, tpl) => {
    ...
    b.styleMap([{
        ...
        property: {
            ...
            height: 'max-content',
            display: 'grid',
            gridTemplate: '1fr / 1fr 12px auto',
        },
    }, {
        ...
        property: {
            ...
            boxShadow: '0 5px 1.7em hsla(0, 0%, 0%, 11%), 0 4px 2em hsla(0, 0%, 0%, 15%)',
            position: 'absolute',
            borderRadius: '4px',
        ...
        selector: '.fraction--zyr4qj::before',
        property: {
            content: '\'\'',
            left: 0,
            right: 0,
            ...
            display: 'block',
            position: 'absolute',
            boxShadow: 'inset 0 0 12px 28px hsl(300deg 3% 7%), inset 0 0 12px 28px hsl(300deg 3% 7%)',
            transform: 'scaleY(33)',
            pointerEvents: 'none',
            zIndex: 1,
        },
        ...
        selector: '.header--bleav0:hover, .header--plp5zo:hover',
        property: {
            color: 'hsl(260, 46%, 52%)',
        },
    }, {
        ...
        selector: '.link--b184gp[status=selected]',
        property: {
            color: 'hsl(264, 43%, 53%)',
                            ...
                            child: [{
                                ...
                                event: {
                                    observe: {
                                        ...
                                        callback: list => {
                                            let layout = document.querySelector('[clip=layout]')
                                                ...
                                                callback: (e, a, t) => {
                                                    ...
                                                    for (let child of header.children) {
                                                        ...
                                                        ch.addEventListener('click', () => {
                                                            t.querySelectorAll('[status=selected]').forEach(f => f.removeAttribute('status'))
                                                            ch.querySelector('span').setAttribute('status', 'selected')
                                                            window.open(github)
                                                        })
                                        ...
                                        clicked: {
                                            node: [{
                                                ...
                                                callback: (e, a, t) => {
                                                    ...
                                                    icon.setAttribute('fill', 'hsl(264, 47%, 45%)')
                                ...
                                event: {
                                    ...
                                    mouseenter: {
                                        node: [{
                                            ...
                                            callback: (e, a, t) => {
                                                t.setAttribute('pointer', 'VIII')
                                                t.children[0].textContent = 'npiu:navigate#close'
                                            },
                                        }],
                                    },
                                    mouseleave: {
