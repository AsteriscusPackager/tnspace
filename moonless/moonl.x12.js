...
window['__params__'] = _=>{var t=location.href.replace(location.origin,'').replace(/^\/|\/$/g,'');if(!t)return;let e=t.split(/\//g),i=[];function n(t,e){this.type=t,this.path=e}for(let t=0;t<e.length;t++)0===t?i.push(new n('first-dir',e[t])):t===e.length-1?i.push(new n('last-dir',e[t])):i.push(new n(`${t+1}th-dir`,e[t]));return i}
                                            ...
                                            node: [{
                                                ...
                                                callback: (e, a, t) => {
                                                    ...
                                                    for (let child of header.children) {
                                                        ...
                                                        content,
                                                        l8c = setInterval(() => {
                                                            if (!null) clearInterval(l8c)
                                                            content = child.querySelector('ml-content').dataset.value
                                                        }, 10)

                                                        let ch = createChild(repoName),
                                    ...
                                    loaded: {
                                        node: [{
                                            ...
                                            callback: (e, a, t) => {
                                                ...
                                                (async _ => createMoonlElement(await getRepos()))()
                                            },
                                        }],
                                    },
                                    observe: {
